...
public class PsiRegionSpecificDataAdapterTest {
    ...
    public void validResponse_NoExceptionThrown() {
        ...
        RegionPsiData[] regionPsiDatas = regionSpecificData.getRegionPsiDatas();
        RegionPsiData east = regionPsiDatas[0];
        RegionPsiData west = regionPsiDatas[1];
        RegionPsiData north = regionPsiDatas[2];
        RegionPsiData south = regionPsiDatas[3];
        RegionPsiData central = regionPsiDatas[4];
